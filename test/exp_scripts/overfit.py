...
from automlToolkit.components.evaluator import Evaluator, fetch_predict_estimator
...
def conduct_fe(dataset='pc4', classifier_id='random_forest', iter_num=100, run_id=0, seed=1):
    ...
    optimizer = EvaluationBasedOptimizer(input_data=raw_data, evaluator=evaluator, model_id=classifier_id,
